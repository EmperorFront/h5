...
return query}
let dom=`
<div class="sizetip hidden">（缩放图片，充满裁剪框效果最佳）</div>
<div id="texttest"></div>
<div id="pagecontent">
...
`;$('#root').html(dom);$('#qrcodorlogobt').hide();$('#labqrcodorlogobt').hide();$('#pagecontent').css({"background-image":"url(https://piccdn.luojilab.com/fe-oss/default/MTU3MDUyMTY1NjE1.jpeg)","width":"100%","height":"100%","position":"absolute","background-size":"cover","top":"0"});$('#root').css({"background-image":"url(https://piccdn.luojilab.com/fe-oss/default/MTU2OTI5MzYzNTE1.png)","min-height":"200px;"})
var hcorrent=window.innerHeight;var wcorrent=window.innerWidth;var nickname;var avatar;var url_from;$(document).ready(function(){var app=document.getElementById("root");var touchstartY;app.addEventListener("touchstart",function(event){var events=event.touches[0]||event;touchstartY=events.clientY;},false);app.addEventListener("touchmove",function(event){var events=event.touches[0]||event;var scrollTop=document.body.scrollTop||document.documentElement.scrollTop;var clientHeight=document.documentElement.clientHeight;var scrollHeight=document.body.scrollHeight;if(events.clientY>touchstartY&&scrollTop<=0&&event.cancelable){event.preventDefault();}},false);});window.___links={checkImg:'https://zt.igetget.com/wxact/api/sifter/img',checkText:'https://zt.igetget.com/wxact/api/sifter/text',userinfolink:'https://pic1cdn.luojilab.com/html/poster/picYwXAgpERJ9f2vpor6XjJ.html',osskeylink:'https://zt.igetget.com/wxact/api/oss-sign',}
if(window.___datasourse___){let container=window.___datasourse___.container;if(container!="igetapp"){let env=window.__wxInfo.env;if(env=='development'||env=='testing'){window.___links={checkImg:'http://zt.iget.dev.didatrip.com/wxact/api/sifter/img',checkText:'http://zt.iget.dev.didatrip.com/wxact/api/sifter/text',userinfolink:'http://pic1cdn.luojilab.com/html/postertest/picppVpAX90wJijmrgOk9vn.html',osskeylink:'http://zt.iget.dev.didatrip.com/wxact/api/oss-sign',shotlink:'http://zt.iget.dev.didatrip.com/wxact/api/surl',preshotlink:'http://d.dev.didatrip.com/',}}
if(env=='simulation'){window.___links={checkImg:'http://zt.dev.igetget.com/wxact/api/sifter/img',checkText:'http://zt.dev.igetget.com/wxact/api/sifter/text',userinfolink:'http://pic1cdn.luojilab.com/html/postersimu/picooJLGW7ZOVtYOnv6EMv4.html',osskeylink:'http://zt.dev.igetget.com/wxact/api/oss-sign',}}
if(env=='production'){window.___links={checkImg:'https://zt.igetget.com/wxact/api/sifter/img',checkText:'https://zt.igetget.com/wxact/api/sifter/text',userinfolink:'https://pic1cdn.luojilab.com/html/poster/picYwXAgpERJ9f2vpor6XjJ.html',osskeylink:'https://zt.igetget.com/wxact/api/oss-sign',shotlink:'https://zt.igetget.com/wxact/api/surl',preshotlink:'https://d.sao.cn/',}}}else{let env=window.___datasourse___.env;if(env=='development'||env=='testing'){window.___links={checkImg:'',checkText:'',userinfolink:'http://pic1cdn.luojilab.com/html/postertest/picppVpAX90wJijmrgOk9vn.html',osskeylink:'http://zt.iget.dev.didatrip.com/wxact/api/oss-sign',}}
if(env=='simulation'){window.___links={checkImg:'',checkText:'',userinfolink:'http://pic1cdn.luojilab.com/html/postersimu/picooJLGW7ZOVtYOnv6EMv4.html',osskeylink:'http://zt.dev.igetget.com/wxact/api/oss-sign',}}
if(env=='production'){window.___links={checkImg:'',checkText:'',userinfolink:'https://pic1cdn.luojilab.com/html/poster/picYwXAgpERJ9f2vpor6XjJ.html',osskeylink:'https://zt.igetget.com/wxact/api/oss-sign',}}}}
var getuserinfolink=function(){window.userinfolinkstr=window.___links.userinfolink+"?nickname="+nickname+"&avatar="+encodeURIComponent(avatar)+"&url_from="+url_from;if(window.___datasourse___){let container=window.___datasourse___.container;if(container!="igetapp"){$.ajax({type:'POST',url:window.___links.shotlink,data:{url:window.userinfolinkstr,},success:function(res){if(res.code===0){window.userinfolinkstr=window.___links.preshotlink+res.rawData.data.id}},})}}}
$('#clickFile').click(function(){$('#file').click();});var word=$('#word');var placeholder='我是得到， \n我每天在拥挤地铁上 \n听「每天听本书」';word.attr('value',placeholder);word.val(placeholder);$(function(){document.getElementById('pagecontent').style.height=($(document).height()>window.innerHeight?$(document).height():window.innerHeight)+'px';if(document.body.scrollHeight>window.innerHeight){var mt=parseInt(hcorrent*(hcorrent/wcorrent-590/375));$('#pagecontent').height(document.body.scrollHeight);$('#pagecontent').css({"margin-top":mt/2*0.2+"px",});}else{var mt=parseInt(hcorrent*(hcorrent/wcorrent-590/375));$('#pagecontent').height($('#pagecontent').height()-(mt/2*0.2));$('#pagecontent').css({"margin-top":mt/2*0.2+"px",});}});word.focus(function(){if($(this).val()===placeholder){$(this).val('');word.css({'background-image':''});}});word.blur(function(){if($(this).val()===''){$(this).val(placeholder);}
window.scroll(0,0);});document.getElementById('file').addEventListener('change',function(e){let file=e.target.files[0];let storeAs='upload-file';$.post(window.___links.osskeylink,(response)=>{sign=response;let formData=new FormData()
...
formData.append("file",file);$('#uploadingtip').show();$('.loading-progress-bar-inner').css({width:'0%'});$('.loading-progress-bar-inner').animate({width:'85%'},3000);var tempcrop_cropstr='?x-oss-process=image/resize,h_800/quality,Q_80'
$.ajax({type:'POST',url:sign.host,data:formData,success:function(res){getuserinfolink();$('#submit').hide();let href=xmlToJson(res).PostResponse.Location['#text'];href=href.replace('com//','com/')
window.pageImageHref=href;checkImg();var cutwidth=199;var cutheight=357;if(window.screen.height/window.screen.width>357/199){cutwidth=parseInt(window.screen.width*0.8);cutheight=parseInt(cutwidth*357/199);}else{cutheight=parseInt(window.screen.height*0.8);cutwidth=parseInt(cutheight*199/357);}
$('#blackmask').css({"margin-top":'-'+$('#pagecontent').css("margin-top"),'height':parseInt($('#pagecontent').css("height"))+$('#pagecontent').css("margin-top")});$('#blackmask').show();$('.sizetip').show();new AlloyCrop({image_src:window.pageImageHref+tempcrop_cropstr,className:'crop-box',circle:false,width:cutwidth,height:cutheight,output:2,ok:function(base64,canvas){$('#cutImgObj').attr('src',crop_cropstr);$('#showTheCut').attr('src',crop_cropstr);$('.crop-box').remove();setTimeout(function(){$('#submit').show();},500);$('#blackmask').hide();$('.sizetip').hide();},cancel:function(){refresh();$('#submit').show();$('#blackmask').hide();$('.sizetip').hide();},ok_text:"裁剪",cancel_text:"取消"});$('.loading-progress-bar-inner').animate({width:'100%'},700,function(){$('#uploadingtip').hide();});if($('#cutImgObj').length){$('#cutImgObj')}else{let dom=`<img id="cutImgObj" src="`+href+`"/> `;$('#pagecontent').append(dom);}
$('#file').attr({'type':'text'});$('#file').attr({'type':'file'});},processData:false,contentType:false})});});function pushPic(showqrcode=true){let sentenst=985;let sentensl=140;let sentensmt=47;let ftonsize=34;let sentenswt=450
let ftcolor='#ff6b00';let sentens=[];var newsentensstart=0;let allsentens=$('#word').val();var texttest=$('#texttest');texttest.width($('#word').width()-1);texttest.html('');texttest.css({'font-size':$('#word').css('font-size'),'line-height':$('#word').css('line-height'),});for(var i=0;i<allsentens.length;i++){texttest.html(allsentens.substring(newsentensstart,i));if(texttest.height()>parseInt(texttest.css('line-height'))+2){sentens.push(allsentens.substring(newsentensstart,i-1));newsentensstart=i-1;}
if(allsentens[i]=='\n'){sentens.push(allsentens.substring(newsentensstart,i));newsentensstart=i+1;}
if(i==allsentens.length-1){sentens.push(allsentens.substring(newsentensstart,allsentens.length));}}
imagen({canvas:{width:750,height:1333,background:'#FF7E37',},layers:[{type:'image',image:'https://piccdn.luojilab.com/fe-oss/default/MTU2OTUwMzYwMDYy.jpeg',left:0,top:0,width:750,height:1333},{type:'image',image:$('#cutImgObj').attr('src'),left:77,top:68,width:596,height:1072},{type:'image',image:'https://piccdn.luojilab.com/fe-oss/default/MTU2ODk2MTg1NDk4.png',left:112,top:858,width:624,height:285},{type:'text',text:sentens[0],left:sentensl,top:sentenst,width:sentenswt,fontSize:ftonsize,height:60,lineHeight:54,color:ftcolor,textAlign:'left'},{type:'text',text:sentens[1],left:sentensl,top:sentenst+sentensmt,width:sentenswt,fontSize:ftonsize,height:6,lineHeight:54,color:ftcolor,textAlign:'left'},{type:'text',text:sentens[2],left:sentensl,top:sentenst+sentensmt*2,width:sentenswt,fontSize:ftonsize,height:60,lineHeight:54,color:ftcolor,textAlign:'left'},showqrcode?{type:'qrcode',text:window.userinfolinkstr,left:613,top:992,width:110,height:110}:{type:'image',image:'https://piccdn.luojilab.com/fe-oss/default/MTU2OTEzMDIwMzAw.jpeg',left:613,top:992,width:110,height:148},showqrcode?{type:'image',image:'https://piccdn.luojilab.com/fe-oss/default/MTU2OTUwNTQyNjA4.png',left:100,top:16,width:110,height:110}:{}]}).then((base64)=>{this.shareImg=base64;$('.shareimg').attr('src',this.shareImg);$('.pg2').show();})}
$('#submit').click(function(){checkText();setTimeout(function(){if(ifsafe()){pushPic($('#qrcodorlogobt')[0].checked);$('#submit').hide();}else{}},500);});function ifsafe(){if((dangeriouspic=='waiting'||dangeriouspic=='safe')&&(dangerioustxt=='waiting'||dangerioustxt=='safe')){if(window.pageImageHref){return true}else{asioforalert.alert({type:'error',title:'请上传图片'});return false}}else{if(window.pageImageHref){}else{asioforalert.alert({type:'error',title:'请上传图片'});return false}
return false}}
var checkImg;var checkText;window.dangeriouspic='waiting';window.dangerioustxt='waiting';var acuid;function refresh(){var random=Math.floor((Math.random()*10000)+1);var url=decodeURI(window.location.href);if(url.indexOf('?')<0){url=url+"?random"+random;}else{url=url.substr(0,url.indexOf('?random'))+"?random"+random;}
window.location.href=url;}
if(window.___datasourse___){env=window.___datasourse___.container;var act_id=window.location.href.split('/');act_id=act_id[act_id.length-1];window.asioforalert=new Asio(env);if(env!="igetapp"){nickname=window.__wxInfo.nickname;avatar=window.__wxInfo.avatar;url_from=window.__wxInfo.unionid;$('.sharebtn').attr('src',"https://piccdn.luojilab.com/fe-oss/default/MTU2OTc1MjU3Njk4.png");$('#qrcodorlogobt').show();$('#labqrcodorlogobt').show();checkImg=function(){$.ajax({type:'POST',url:window.___links.checkImg,data:{"url":window.pageImageHref,"act_id":act_id},success:function(e){if(e.code===0){window.dangeriouspic='safe';if(e.rawData.data){window.picsafecode=e.rawData.data.id}else{window.picsafecode='';}
if(!window.picsafecode){window.dangeriouspic=e.rawData.err_msg;asioforalert.alert({type:'error',title:dangeriouspic?dangeriouspic:'请求频率过高'});window.tooquickly='tooquickly';setTimeout(function(){refresh();},1500);}}else{window.dangeriouspic=e.rawData.err_msg;asioforalert.alert({type:'error',title:dangeriouspic?dangeriouspic:'风控服务器繁忙'});}},});};checkText=function(){if(window.picsafecode){$.ajax({type:'POST',url:window.___links.checkText,data:{"id":window.picsafecode,"comment":$('#word').val()},success:function(e){if(e.rawData.status===200){window.dangerioustxt='safe';}else{window.dangerioustxt=e.rawData.err_msg;if(window.picsafecode){asioforalert.alert({type:'error',title:dangerioustxt});}}},});}};}
else if(env=='igetapp')
{$('.sharebtn').click(function(){refresh();});var sharepicbutton=`<div class= "sharepicbutton"></div>`
$('.pg2').append(sharepicbutton);$('.sharepicbutton').click(function(){Asio.send('network.load',{url:'$_ENTREE_DOMAIN_$/allblue/coupon/send?uid='+acuid,method:'POST',params:{uid:acuid,},contentType:'application/x-www-form-urlencoded',proxyType:'gateway/entree',}).then(res=>{var conf={type:1,image:$('.shareimg').attr('src'),channel:[0,1,2,3,6,9,10],}
Asio.send('agent.share',conf).then(res=>{var content={'name':'H5页面_点击海报分享模块'}
asioforalert.nlog('s_h5_poster_share',content);});});});act_id=window.___datasourse___.aid;Asio.send('agent.info').then(res=>{acuid=res.data.userid;nickname=res.data.nickname;avatar=res.data.avatar;url_from=res.data.userid;});$('.sharebtn').attr('src',"https://piccdn.luojilab.com/fe-oss/default/MTU2OTEzMTExNjEz.png");$('#qrcodorlogobt').show();$('#labqrcodorlogobt').show();checkImg=function(){Asio.send('network.load',{url:'$_ENTREE_DOMAIN_$/activityback/wechat/img',method:'POST',params:{url:window.pageImageHref,source:'app',uid:acuid,act_id:act_id,},contentType:'application/x-www-form-urlencoded',proxyType:'gateway/entree',}).then(res=>{if(res.status_code===0){window.dangeriouspic='safe';if(res.data.data){window.picsafecode=res.data.data.id}else{window.picsafecode='';}
if(!window.picsafecode){window.dangeriouspic=res.data.err_msg;asioforalert.alert({type:'error',title:dangeriouspic?dangeriouspic:'请求频率过高'});window.tooquickly='tooquickly';setTimeout(function(){location.reload();},1500);}}else{window.dangeriouspic=res.data.err_msg;asioforalert.alert({type:'error',title:dangeriouspic});}})};checkText=function(){Asio.send('network.load',{url:'$_ENTREE_DOMAIN_$/activityback/wechat/text',method:'POST',params:{"id":window.picsafecode,"comment":$('#word').val()},contentType:'application/x-www-form-urlencoded',proxyType:'gateway/entree',}).then(res=>{if(res.data.status===200){window.dangerioustxt='safe';}else{window.dangerioustxt=res.data.err_msg;if(window.picsafecode){asioforalert.alert({type:'error',title:dangerioustxt});}}})};}}
else{$('.sharebtn').attr('src',"https://piccdn.luojilab.com/fe-oss/default/MTU2OTc1MjU3Njk4.png");$('#qrcodorlogobt').show();$('#labqrcodorlogobt').show();}
$('#qrcodorlogobt').change(function(){pushPic($('#qrcodorlogobt')[0].checked);})
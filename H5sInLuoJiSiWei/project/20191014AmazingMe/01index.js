...
$('#pagecontent').css({
    "background-image": "url(https://piccdn.luojilab.com/fe-oss/default/MTU3MDc4NDk1MTM1.jpeg)",
    "width": "100%",
    "height": "100%",
    "position": "absolute",
    ...
    $.post(window.___links.osskeylink, (response) => {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $('#blackmask').css({
                    "margin-top": '-' + $('#pagecontent').css("margin-top"),
...
function pushPic(showqrcode = true) {
    ...
    texttest.css({
        ...
        'line-height': $('#word').css('line-height'),
    });

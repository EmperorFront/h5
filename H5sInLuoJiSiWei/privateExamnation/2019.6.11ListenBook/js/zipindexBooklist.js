...
canTouch=false;window.isTouch=false;});$('#close').click(function(){$('#info').hide();$('#rules').hide();$('#listinfo').hide();thewindow.hide();canTouch=true;clearInterval(si);});var si;$('.list').click(function(){$('#listinfo').show();var i=0;si=setInterval(function(){var thediv=$('#'+i);MTween({el:thediv[0],target:{opacity:-100,marginTop:-1*thediv.height()},time:800,type:'linear',callBack:function(){thediv.hide()
